...
function e(t, i, s) {
    ...
    1 : [function(e, t) {
        function i(e) {
            ...
            this.src = e,
            this.element = null,
            "undefined" != typeof e && this.create()
        }
    ...
    3 : [function(e, t) {
        ...
        i.prototype.getImageSrcs = function(e) {
            "use strict";
            if (this.sources = [], "undefined" != typeof e && (this.findImageInElement(e), this.deepSearch === !0)) for (var t = e.querySelectorAll("*"), i = 0; i < t.length; i++)"SCRIPT" !== t[i].tagName && this.findImageInElement(t[i]);
            return this.sources
        },
        ...
        i.prototype.findImageInElement = function(e) {
            ...
            if (!this.hasGradient(t.url)) {
                ...
                for (var i = t.url.split(", "), s = 0; s < i.length; s++) if (this.validUrl(i[s]) && this.urlIsNew(i[s])) {
        ...
        i.prototype.hasGradient = function(e) {
            "use strict";
            return ("undefined" != typeof e && "undefined" != typeof e.indexOf) ? -1 !== e.indexOf("gradient(") : !1
        },
    ...
    4 : [function(e, t) {
        ...
        i.prototype.updateProgress = function(e, t) {
            "use strict";
            parseInt(e) < 0 ? e = 0 : parseInt(e) > 100 && (e = 100),
            0 !== t && this.setTransitionTime(t),
            this.element.style.width = parseInt(e) + "%"
        },
    ...
    5 : [function(e, t) {
        ...
        i.prototype.updateProgress = function(e) {
            "use strict";
            parseInt(e) < 0 ? e = 0 : parseInt(e) > 100 && (e = 100),
            this.element.innerHTML = parseInt(e) + "%"
        },
        t.exports = i
    },
    {}],
    ...
    9 : [function(e, t) {
        e("./Polyfills/");
        var i = e("./QueryLoader.js"); (window.jQuery || window.Zepto) && !
        function(e) {
            "use strict";
